...
account_sid ='ACfa570e3adc080ac9fb12976183803614'
auth_token = '1f7db18e77de3f399b3d207ae20cf43d'
...
def login_registration_dtls() :
    ...
    if travel_pass < 30 and request.method == 'POST' :
        status = 'CONFIRMED'
        client.messages.create(to="whatsapp:+919493119495",
                                from_ ="whatsapp:+14155238886",
                                body ="Hello, '"+ full_name+"'. "+"Your travel From"+" "+ source_dt+" to "+	destination_dt +","+destination_st+" on '"+date+"' is confirmed")
        ...
        client.messages.create(to="whatsapp:+919493119495",
                                from_ ="whatsapp:+14155238886",
                                body ="Hello "+" "+ full_name+" "+"Your travel From"+" "+ source_dt+" "+"is  not confirmed")
        return render_template('user_registration_dtls.html', var=full_name, var1=email_id, var2=id_proof,
                               var3=source_st, var4=source_dt, var5=destination_st, var6=destination_dt,
                               var7=phoneNumber, var8=date, var9=status)
